      ...
      methods: {
        saveOrUpdate() {
          ...
          this.saveBtnDisabled = true
                    // teacher数据的获取
          teacherApi.saveRecord(this.book).then(response => {
            this.$message({
              type: 'success',
        ...
        fetchDataById(id) {
          teacherApi.getById(id).then(response => {
            ...
            this.book.bname = this.book.name
          })
        },
        // 根据id更新记录
        updateData() {
          // teacher数据的获取
          teacherApi.saveRecord(this.book, this.reader).then(response => {
            this.$message({
              type: 'success',
              message: response.message
            })
